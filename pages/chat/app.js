...
chatPersonItems.forEach((item) => {
  item.addEventListener('click', function () {
    handleItemChatClick(this, [chatGroupDetail, startChat], [chatPersonalDetail], 'list-group-item--active')();
...
chatGroupItems.forEach((item) => {
  item.addEventListener('click', function () {
    handleItemChatClick(this, [chatPersonalDetail, startChat], [chatGroupDetail], 'list-group-item--active')();
